      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8 max-w-4xl">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
            <UserIcon className="w-8 h-8 sm:w-12 sm:h-12 text-blue-600" />
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-500 bg-clip-text text-transparent">
              Your Profile
            </h1>
          </div>
          <p className="text-gray-700 text-sm sm:text-lg px-4">
        ...
        {loading ? (
          ...
          <Tabs defaultValue="personal" className="w-full">
            <TabsList className="grid w-full max-w-2xl mx-auto grid-cols-2 mb-4 sm:mb-8">
              ...
              <TabsTrigger value="achievements" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm">
                ...
                <span className="hidden sm:inline">Badges & Achievements</span>
                <span className="sm:hidden">Badges & Achieve...</span>
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="personal" className="space-y-4 sm:space-y-6">
              ...
              <Card className="bg-white/90 backdrop-blur-sm border-blue-300">
                <CardHeader className="pb-3 sm:pb-6">
                  <CardTitle className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-2">
                    <div className="flex items-center gap-2">
                      <UserIcon className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
                      <span className="text-base sm:text-lg">Account Information</span>
                    </div>
                    <button
                      type="button"
                      onClick={() => setIsShareOpen(true)}
                      className="inline-flex items-center justify-center px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-md w-full sm:w-auto"
                    >
                ...
                <CardContent className="space-y-3 sm:space-y-4">
                  <div className="flex items-center justify-center mb-4 sm:mb-6">
                    <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white text-3xl sm:text-4xl font-bold">
                      {username.charAt(0).toUpperCase()}
                    </div>
                  </div>

                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 p-3 bg-blue-50 rounded-lg">
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        <UserIcon className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 flex-shrink-0" />
                      ...
                      {editing ? (
                        <div className="flex gap-2 w-full sm:w-auto">
                          <Button size="sm" onClick={updateUsername} className="flex-1 sm:flex-none">Save</Button>
                        ...
                        <Button size="sm" variant="outline" onClick={() => setEditing(true)} className="w-full sm:w-auto">
                          Edit
                        </Button>
                      )}
                    </div>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-sm font-semibold text-gray-900">
                          ...
                          <span className="text-xs text-gray-600 ml-1 sm:ml-2 block sm:inline">({accountAge} days ago)</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                    <div className="p-3 sm:p-4 bg-blue-50 rounded-lg text-center">
                      ...
                      <div className="text-xl sm:text-2xl font-bold text-blue-700">{userData.stats.totalGames}</div>
                      <div className="text-xs text-gray-700">Total Games</div>
                    </div>

                    <div className="p-3 sm:p-4 bg-green-50 rounded-lg text-center">
                      <Trophy className="w-5 h-5 sm:w-6 sm:h-6 mx-auto mb-1 sm:mb-2 text-green-600" />
                      <div className="text-xl sm:text-2xl font-bold text-green-700">{userData.stats.wins}</div>
                      <div className="text-xs text-gray-700">Wins</div>
                    </div>

                    <div className="p-3 sm:p-4 bg-amber-50 rounded-lg text-center">
                      <Zap className="w-5 h-5 sm:w-6 sm:h-6 mx-auto mb-1 sm:mb-2 text-amber-600" />
                      <div className="text-xl sm:text-2xl font-bold text-amber-700">{winRate.toFixed(2)}%</div>
                      <div className="text-xs text-gray-700">Win Rate</div>
                    </div>

                    <div className="p-3 sm:p-4 bg-purple-50 rounded-lg text-center">
                      <Crown className="w-5 h-5 sm:w-6 sm:h-6 mx-auto mb-1 sm:mb-2 text-purple-600" />
                      <div className="text-xl sm:text-2xl font-bold text-purple-700">{userData.stats.highestScore}</div>
